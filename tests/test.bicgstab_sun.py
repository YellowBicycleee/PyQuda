...
if __name__ == '__main__' :
    ...
    # warm up
    for i in range(10):
        test_dslash(my_n_color, max_input, input_prec=my_input_prec, dslash_prec=my_dslash_prec, quda_average_time = quda_average_time, qcu_average_time = qcu_average_time, warmup_flag = True)
