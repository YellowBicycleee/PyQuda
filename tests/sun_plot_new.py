...
if __name__ == '__main__' :
    ...
    y = [   
            ...
            np.array (
                [
                    ...
                    0.394833041, 0.39609008, 0.397355469, 0.398637569, 0.399894583, 0.511965272, 
                    0.514437335, 0.516110778, 0.517372258, 0.518643581, 0.522596534, 0.522702558, 
                    0.522889276, 0.553761364, 0.602495438, 0.65637587, 0.725440847, 0.801831925, 
                    0.924620558, 0.962810952, 0.981521426
                ]
            ),
            # Nc = 8
            np.array(
            ...
            np.array(
                [
                    ...
                    0.381465662, 0.382985901, 0.382924513, 0.383084758, 0.545186278, 0.596938188, 
                    0.652309718, 0.722614028, 0.799964019, 0.923958931, 0.962495504, 0.981367422
                ]
            )
        ]
    ...
    const = \
        [
            ...
            np.array (
                [
                    0.6, 0.8, 1, 1.25, 1.5, 1.6, 1.7, 1.75, 1.8, 1.9, 2, 2.02, 2.025, 
                    2.0275, 2.03, 2.0325, 2.035, 2.036, 2.037, 2.038, 2.039, 2.04, 
                    2.044, 2.04401, 2.0442, 2.1, 2.25, 2.5, 3, 4, 10, 20, 40
                ]
            ),
            # Nc = 8
            np.array(
            ...
            np.array(
                [
                    0.6, 0.8, 1, 1.25, 1.5, 1.6, 1.7, 1.75, 1.8, 1.9, 2, 2.02, 2.04, 
                    2.044, 2.04401, 2.0442, 2.1, 2.25, 2.5, 3, 4, 10, 20, 40
                ]
            )
        ] 
