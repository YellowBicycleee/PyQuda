...
if __name__ == '__main__' :
    ...
    y = [   
            ...
            np.array(    
                [   
                    0.115104473, 0.158361463, 0.204730448, 0.267972155, 0.339767097, 0.373730368, 
                    0.415481017, 0.440516203, 0.471601799, 0.549355546, 0.593490618, 0.600022052, 
                    0.606105517, 0.607953385, 0.608867503, 0.612208795, 0.614339885, 0.617444558,
                    0.620103767, 0.622885892, 0.65594721, 0.698288842, 0.756298032, 0.822488635, 
                    0.931786425, 0.966285772, 0.98324457
                ]
            ),
            # Nc = 4
            np.array(
        ...
        [
            ...
            np.array(
                [   
                    ...
                    2.05, 2.06, 2.07, 2.08, 2.09, 2.1, 2.25, 2.5, 3, 4, 10, 20, 40
                ]
            ), 
            # Nc = 4
            np.array(
